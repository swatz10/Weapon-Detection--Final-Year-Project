...
if __name__ == '__main__':
    ...
    pickle_out=open(r"D:\FINAL YEAR\code\knife_model_inception_finetune.pkl","wb")
    ...
    pickle_in=open(r"D:\FINAL YEAR\code\knife_model_inception_finetune.pkl","rb")
    model=pickle.load(pickle_in)
    pickle_in.close()
    score = model.evaluate(X_test, y_bin_test, verbose=1)
    print("after evaluation (pickled model):")
    print(score)
